...
imagefile = 'cobblestone.jpg';
ntilesout = [20 20];   % how many tiles wide and tall the output should be
tilesize = 25;    % the size of the tiles we paste down (assumed square)
overlap = 10;      % how much overlap should there be between neighboring tiles
K = 10;            % number of top candidate matches we choose from
...
figure, imshow(output_quilt);

imwrite(sampleI, 'cobblestone sample.jpg');
imwrite(output_quilt, 'cobblestone quilt.jpg');
